...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun saveProfileInfo() {
        ...
        getSharedPreferences("UserProfile", MODE_PRIVATE).edit {
            putString("name_$currentUser", etName.text.toString())
            putString("phone_$currentUser", etPhone.text.toString())
            putString("email_$currentUser", etEmail.text.toString())
        }
    }
    ...
    private fun loadProfileData() {
        ...
        etJoinDate.setText(prefs.getString("join_$currentUser", "Baru Bergabung"))
